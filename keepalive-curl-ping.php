...
#commit 2
function surf($url){
	$agentArr = array("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/37.0.2062.94 Chrome/37.0.2062.94 Safari/537.36",
...
"Mozilla/5.0 (Linux; Android 5.0; SAMSUNG SM-N900T Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36",
	...
	$agent = $agentArr[array_rand($agentArr)];
	$ch = curl_init($url);
...
surf("sg1.thepdahoi.com");
surf("thepdahoi.com");
surf("sg2.thepdahoi.com");
surf("sg3.thepdahoi.com");
surf("sg4.thepdahoi.com");
surf("sg5.thepdahoi.com");
surf("sg6.thepdahoi.com");
surf("kr1.thepdahoi.com");
surf("kr2.thepdahoi.com");
surf("jp1.thepdahoi.com");
surf("jp2.thepdahoi.com");
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
    echo exec("ping -n 2 sg1.thepdahoi.com > NUL");
	echo exec("ping -n 2 sg2.thepdahoi.com > NUL");
	echo exec("ping -n 2 sg3.thepdahoi.com > NUL");
	echo exec("ping -n 2 sg4.thepdahoi.com > NUL");
	echo exec("ping -n 2 sg5.thepdahoi.com > NUL");
	echo exec("ping -n 2 sg6.thepdahoi.com > NUL");
	echo exec("ping -n 2 kr1.thepdahoi.com > NUL");
	echo exec("ping -n 2 kr2.thepdahoi.com > NUL");
	echo exec("ping -n 2 jp1.thepdahoi.com > NUL");
	echo exec("ping -n 2 jp2.thepdahoi.com > NUL");
} else {
    echo exec("ping -c 2 sg1.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 sg2.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 sg3.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 sg4.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 sg5.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 sg6.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 kr1.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 kr2.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 jp1.thepdahoi.com > /dev/null");
	echo exec("ping -c 2 jp2.thepdahoi.com > /dev/null");
}
